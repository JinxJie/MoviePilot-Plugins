...
| 插件诊所 | [`plugins.v2/pluginclinic`](plugins.v2/pluginclinic) | 1.0.0 | 扫描无法加载的插件与卸载残留，一键清理，让重新安装一路顺畅 |
...
**功能：**
扫描并清理 MoviePilot 中无法加载的插件与卸载残留，手动勾选清理，一键清干净，让重新安装一路顺畅。
...
**更新说明：**
- v1.0.0：首发版本，支持自动扫描、手动勾选清理、一键清理、清理记录与通知。
